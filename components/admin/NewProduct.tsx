...
export const NewProduct: React.FC<Props> = ({ className }) => {
  ...
  return (
    <div className={className}>
      ...
      <div className='flex justify-center items-start gap-4'>
        <form action={action} className='bg-white p-4 rounded-lg mt-4 w-[60%]'>
        ...
        <div className='bg-white p-4 rounded-lg mt-4 w-[40%] self-stretch'>
          ...
          <div className='p-3 bg-violet-200 mt-4 rounded-lg text-violet-600'>
            <div className='flex items-center justify-start gap-2'>
              ...
              <p className='text-violet-600 font-bold'>Tips</p>
            </div>
            <ul className='text-violet-600 mt-2 list-disc px-4'>
              <li>Make sure all required fields are filled</li>
              <li>Use a clear, high-quality image URL</li>
